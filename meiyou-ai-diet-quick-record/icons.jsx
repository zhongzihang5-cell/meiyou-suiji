...
const Icon = ({name, size=20, stroke=1.6, ...p}) => {
  ...
  switch(name){
    ...
    case 'chevron-left': return (
      <svg {...common} strokeWidth={Math.max(stroke, 2)}>
        <path d="M15 6l-6 6 6 6"/>
      </svg>
    );
    ...
    case 'camera-flip': return (
      <svg {...common} strokeLinecap="round" strokeLinejoin="round">
        <path d="M7 7h2.5a4.5 4.5 0 014.5 4.5V14"/>
        <path d="M7 7L5 5"/>
        <path d="M7 7L5 9"/>
        <path d="M17 17h-2.5a4.5 4.5 0 01-4.5-4.5V10"/>
        <path d="M17 17l2-2"/>
        <path d="M17 17l2 2"/>
      </svg>
    );
    ...
    case 'help': return (
      <svg {...common} strokeWidth={Math.max(stroke, 2)}>
        <circle cx="12" cy="12" r="9"/>
        <path d="M9.5 9a2.5 2.5 0 114.8 1c0 2-2.8 1.9-2.8 4.2"/>
